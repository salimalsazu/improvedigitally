...
const Hero = () => {
    return (
        <div className='flex flex-col-reverse lg:flex-row justify-center items-center mx-5 lg:mx-10 gap-20' >
            <div className='flex flex-col justify-center items-start'>
                <h1 className='text-[#F87D5E] font-bold mb-5'>Grow Digitally</h1>
                <p className='text-3xl lg:text-6xl text-[#30445C] font-bold' >Boosts your <br /> <span className='text-[#F87D5E]' >website traffic!</span></p>
