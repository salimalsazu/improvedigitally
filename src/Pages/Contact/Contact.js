...
const Contact = () => {
    ...
    return (
        <div>
            ...
            <div className='flex flex-col lg:flex-row mt-20 gap-4 lg:gap-10 justify-center items-center lg:items-start' >
                <div className='flex flex-col' >
                    <div className='flex flex-col justify-center items-center' >
                        <h1 className='text-[#30445C] text-xl lg:text-3xl  text-center font-semibold' >We can't wait to <span className='text-[#F87D5E]' >hear from <br /> you!</span></h1>
                ...
                <div className='lg:-mt-40 bg-white rounded-2xl' >
